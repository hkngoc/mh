...
const VoteBonusWithTarget = function(ref) {
  MyBaseNode.apply(this, [ref]);
};

VoteBonusWithTarget.prototype = newChildObject(MyBaseNode.prototype);

VoteBonusWithTarget.prototype.tick = function(tree) {
  ...
  blackboard.set('bonusWinner', { ...lastResult, watch: true }, true);

  return SUCCESS;
};

export default VoteBonusWithTarget;
